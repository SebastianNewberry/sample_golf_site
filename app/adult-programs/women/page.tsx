...
import golfForWomen from "@/public/golf_for_women.webp";
            ...
            <div className="lg:col-span-4 space-y-6">
              ...
              <div className="bg-white rounded-xl p-8 shadow-sm">
                <p className="text-gray-700 leading-relaxed mb-4">
                  <strong className="text-gray-800">GOLF FOR WOMEN</strong> is
                  our time-tested program that has resulted in new golfers and
                  experienced players learning to love the game, experience a
                  great sense of accomplishment and develop the confidence to
                  play on a golf course.
                </p>
                <p className="text-gray-700 leading-relaxed">
                  Each class lasts for five (5) weeks and provides personalized
