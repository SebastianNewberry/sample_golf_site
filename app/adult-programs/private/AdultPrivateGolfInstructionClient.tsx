...
export function AdultPrivateGolfInstructionClient({
  ...
  const handleSlotSelect = (slot: any) => {
    ...
    // Don't close immediately, let them confirm in sidebar
  };
              ...
              <div className="flex flex-col">
                ...
                <div className="relative bg-gray-100">
                  <Image
                    ...
                    width={800}
                    height={500}
                    className="w-full max-h-[350px] object-cover bg-gray-100"
                    priority
                  />
                </div>
                ...
                <div className="p-6 lg:p-8">
                  ...
                  <div className="space-y-4 mb-8">
                    <p className="text-sm text-gray-600 leading-relaxed">
                      ...
                      <strong> Paul Toski, PGA Professional</strong>. We
                      identify your goals and any physical limitations that may
                      affect your swing.
                    </p>
                    <p className="text-sm text-gray-600 leading-relaxed">
                      High-speed video analysis of your swing with specific
                      drills and training aids to improve your golf skills.
                    </p>
                  </div>
                  ...
                  <div className="mb-10 p-6 bg-gray-50 rounded-2xl border border-gray-100">
                    ...
                    <p className="text-sm text-gray-600 mb-6 leading-relaxed max-w-4xl">
                      ...
                      you how to take your game from the practice area to the
                      golf course. You will learn under real playing conditions
                      and receive invaluable instruction on all aspects of your
