    ...
    <div className="bg-white rounded-xl shadow-lg overflow-hidden">
      ...
      <div className="p-6">
        ...
        <p className="text-gray-700 text-sm leading-relaxed mb-2">
          ...
          skills and improve on-course play, and for those players who aspire to
          play or are already playing competitive golf.
        </p>
        <p className="text-gray-600 text-sm leading-relaxed mb-2">
          The <strong>Junior Developmental Series</strong> builds on principles
          learned in <strong>Junior Beginner Series</strong>.
        </p>
        <p className="text-gray-600 text-sm leading-relaxed mb-4">
          You can choose either a package of five (5) or fifteen (15) two-hour
          supervised practice sessions. A personalized improvement plan will be
          developed for each student based on his or her goals, ability and
          commitment level. The plan includes: prioritizing skills that still
          need development, planned practices and drills, on-course strategy and
